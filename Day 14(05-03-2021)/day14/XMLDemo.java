...
//	}
	...
	System.out.println(rootElement.getFirstChild().getFirstChild().getNodeName());
	System.out.println(rootElement.getFirstChild().getFirstChild().getNodeName());
	
	System.out.println(rootElement.getFirstChild().getNextSibling().getNodeName());
	System.out.println(rootElement.getFirstChild().getFirstChild().getNextSibling().getNodeName());
}
}